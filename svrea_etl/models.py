...
class EtlListings(models.Model):
    ...
    listing_area_max        = models.IntegerField(null=True, blank=True)
    listing_area_min        = models.IntegerField(null=True, blank=True)
    listing_area_med        = models.IntegerField(null=True, blank=True)
    listing_rent_avg        = models.IntegerField(null=True, blank=True)
    listing_rent_max        = models.IntegerField(null=True, blank=True)
    listing_rent_min        = models.IntegerField(null=True, blank=True)
    ...
    sold_area_max           = models.IntegerField(null=True, blank=True)
    sold_area_min           = models.IntegerField(null=True, blank=True)
    sold_area_med           = models.IntegerField(null=True, blank=True)
    sold_rent_avg           = models.IntegerField(null=True, blank=True)
    sold_rent_max           = models.IntegerField(null=True, blank=True)
    sold_rent_min           = models.IntegerField(null=True, blank=True)
