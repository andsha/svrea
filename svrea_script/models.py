...
class Listings(models.Model):
    ...
    plotarea            = models.DecimalField(max_digits=10, decimal_places=1, null=True, blank=True)
    additionalarea      = models.DecimalField(max_digits=10, decimal_places=1, null=True, blank=True)
    livingarea          = models.DecimalField(max_digits=10, decimal_places=1, null=True, blank=True)
